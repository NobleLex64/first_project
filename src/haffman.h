#ifndef COMPRESSION_ALGORTIM_HAFFMANA
#define COMPRESSION_ALGORTIM_HAFFMANA

/// produced.. Noble_lex 64, 05.2024
/// algoritm Haffmana (compression and decompression)
/// used my libs "myAlg.h"
/// WARNING: have one problem, if data.size() % 8 != 0, then the last characters will be decrypted incorrectly
...
#endif //COMPRESSION_ALGORTIM_HAFFMANA